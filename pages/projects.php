...
<html lang="fr">
    ...
    <body>
        ...
        <main class="container">
            <div class="projects">
                <h1>My projects</h1>
                <p>Here are some of my projects, you can find more on my <a href="https://github.com/Isnubi/" target="_blank">Github</a>!</p>
                <fieldset id="portfolio">
                    ...
                    <div class="project">
                        ...
                        <p>It's open source, you can find it on <a href="https://github.com/Isnubi/Portfolio" target="_blank">Github</a>.</p>
                    </div>
                ...
                <fieldset id="feurbot">
                    ...
                    <div class="project">
                        ...
                        <p>It's open source, you can find it on <a href="https://github.com/Isnubi/FeurBot" target="_blank">Github</a>.</p>
                    </div>
                ...
                <fieldset id="twt">
                    ...
                    <div class="project">
                        ...
                        <p>It's hosted on a web server that I rent.</p>
                        <p>It's open source, you can find it on <a href="https://github.com/Isnubi/Technology_watch_tool" target="_blank">Github</a>.</p>
                    </div>
