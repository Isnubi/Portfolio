    ...
    <main class="container">
        <div class="card shadow p-3 mb-5 border-primary rounded">
            <div class="card-body text-grey text-center">
                <h5 class="card-title">Mise en place d'un serveur OCS & GLPI</h5>
                <p class="card-text">Procédure de mise en place d'un serveur de gestion de parc informatique (OCS Inventory NG) et de gestion d'incidents/ticketing (GLPI) dans un environnement Linux (Debian).</p><br>
