    ...
    <main class="container">
        <div class="card shadow p-3 mb-5 border-primary rounded">
            <div class="card-body text-grey text-center">
                <h5 class="card-title">Mise en place de STP - Cisco Packet Tracer</h5>
                <p class="card-text">Procédure de mise en place du protocole STP sur Cisco Packet Tracer.</p><br>
