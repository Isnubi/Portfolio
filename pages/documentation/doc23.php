    ...
    <main class="container">
        <div class="card shadow p-3 mb-5 border-primary rounded">
            <div class="card-body text-grey text-center">
                <h5 class="card-title">Mise en place de partage de fichiers SMB en Powershell</h5>
                <p class="card-text">Procédure de mise en place de partage de fichiers avec le protocole SMB, en Powershell, à l'aide du module NTFSSecurity.</p><br>
