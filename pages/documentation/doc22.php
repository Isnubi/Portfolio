    ...
    <main class="container">
        <div class="card shadow p-3 mb-5 border-primary rounded">
            <div class="card-body text-grey text-center">
                <h5 class="card-title">Installation des outils RSAT - Windows 10</h5>
                <p class="card-text">Procédure d'installation des outils d'administration à distance RSAT sur un environnement Windows 10.</p><br>
