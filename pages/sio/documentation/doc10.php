    ...
    <main class="container">
        <div class="card shadow p-3 mb-5 border-primary rounded">
            <div class="card-body text-grey text-center">
                <h5 class="card-title">Ajout d'un hôte Windows à un domaine Active Directory</h5>
                <p class="card-text">Procédure d'ajout d'un hôte Windows (serveur ou ordinateur) dans un domaine Active Directory.</p><br>
                ...
                <div class="text-center">
                    <a href="https://1drv.ms/b/s!Ao2b5EOSGdNPlFvH6QmG005PB4rq" target="_blank" class="btn btn-primary">Accès à la production associée</a><br><br>
                </div>
            </div>
        </div>
        <div class="text-center">
