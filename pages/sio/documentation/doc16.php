    ...
    <main class="container">
        <div class="card shadow p-3 mb-5 border-primary rounded">
            <div class="card-body text-grey text-center">
                <h5 class="card-title">Ajout d'un hôte Linux dans un domaine Active Directory</h5>
                <p class="card-text">Procédure d'ajout d'un hôte Linux (serveur ou ordinateur) dans un domaine Active Directory.</p><br>
