    ...
    <main class="container">
        <div class="card shadow p-3 mb-5 border-primary rounded">
            <div class="card-body text-grey text-center">
                <h5 class="card-title">Création de machine virtuelle - VMWare ESXi</h5>
                <p class="card-text">Procédure de création d'une machine virtuelle dans un environnement VMWare ESXi.</p><br>
