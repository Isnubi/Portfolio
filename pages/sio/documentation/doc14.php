    ...
    <main class="container">
        <div class="card shadow p-3 mb-5 border-primary rounded">
            <div class="card-body text-grey text-center">
                <h5 class="card-title">Mise en place d'une authentification LDAP - VMWare vCenter</h5>
                <p class="card-text">Procédure de mise en place d'une authentification via Active Directory LDAP sur l'instance vCenter.</p><br>
